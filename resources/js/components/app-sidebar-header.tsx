...
export function AppSidebarHeader({
    ...
    return (
        <header className="flex h-16 shrink-0 items-center gap-3 border-b border-white/70 bg-card/80 px-4 shadow-[var(--shadow-soft)] backdrop-blur-[16px] transition-[width,height] duration-200 ease-linear dark:border-white/10 md:px-6">
