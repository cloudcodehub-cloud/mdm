                        ...
                        {auth.user ? (
                            ...
                            <>
                                ...
                                <span
                                    ...
                                    className="inline-block cursor-not-allowed rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] opacity-50 dark:border-[#3E3E3A] dark:text-[#EDEDEC]"
                                >
                                    Register
                                </span>
                            </>
