...
trait ValidatesLocationAttestation
{
    protected function prepareLocationAttestation(): void
    {
     ...
     */
    protected function locationAttestationRules(): array
    {
        return [
    ...
    protected function afterLocationAttestation(Validator $validator): void
    {
