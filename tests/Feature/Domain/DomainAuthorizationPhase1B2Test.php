...
class DomainAuthorizationPhase1B2Test extends TestCase
{
    ...
    public function test_supervisors_can_view_assigned_care_plans_and_visits(): void
    {
        ...
        $this->assertTrue(Gate::forUser($user)->allows('create', CarePlan::class));
        $this->assertTrue(Gate::forUser($user)->allows('update', $plan));
        $this->assertTrue(Gate::forUser($user)->denies('update', $otherPlan));
